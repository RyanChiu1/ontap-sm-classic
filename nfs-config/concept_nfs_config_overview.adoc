---
permalink: nfs-config/concept_nfs_config_overview.html
sidebar: sidebar
keywords: guide, nfs, access, volume, exist, storage, virtual, machine, svm, decide whether to use the nfs configuration express guide
summary: "This guide describes how to quickly set up NFS access to a new volume on either a new or existing storage virtual machine (SVM)."
---
= Decide whether to use the NFS Configuration Express Guide
:icons: font
:imagesdir: ../media/
