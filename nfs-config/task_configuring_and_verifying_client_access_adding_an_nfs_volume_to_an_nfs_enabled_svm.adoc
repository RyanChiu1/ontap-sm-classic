---
permalink: nfs-config/task_configuring_and_verifying_client_access_adding_an_nfs_volume_to_an_nfs_enabled_svm.html
sidebar: sidebar
keywords: 
...
---
= Configuring and verifying NFS client access (Adding an NFS volume to an NFS-enabled SVM)
:icons: font
:imagesdir: ../media/
