---
permalink: nfs-config/task_creating_a_new_svm.html
sidebar: sidebar
keywords: 
...
+
image::../media/svm_setup_details_unix_selected.gif[This graphic is explained by the surrounding text.]
...
+
image::../media/svm_setup_cifs_nfs_page_nfs_export.gif[Screenshot of the area where you configure the NFS export]
+
...
+
image::../media/export_rule_for_admin_manual_nfs.gif[This image is explained by the surrounding text.]
