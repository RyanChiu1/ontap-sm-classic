---
permalink: online-help-96-97/task_creating_a_mirror_and_vault_relationship_from_a_source_svm.html
sidebar: sidebar
keywords: 
...
. Click *image:../media/nas_bridge_202_icon_settings.gif[]*, update the protection policy and protection schedule, select *FabricPool-enabled aggregate*, and then initialize the protection relationship.
. Click *Save*.
