---
permalink: fc-config-windows/concept_deciding_whether_to_use_this_guide_fc_windows.html
sidebar: sidebar
keywords: 
...
---
= Deciding whether to use the FC Configuration for Windows Express Guide
:icons: font
:imagesdir: ../media/
