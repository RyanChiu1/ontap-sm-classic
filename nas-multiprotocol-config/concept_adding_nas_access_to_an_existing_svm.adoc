---
permalink: nas-multiprotocol-config/concept_adding_nas_access_to_an_existing_svm.html
sidebar: sidebar
keywords: 
...
+
image::../media/svm_setup_cifs_nfs_page_cifs_share.gif[Screenshot of the area where you configure the CIFS share]
