...
sidebar: sidebar
keywords: guide, describe, fc, service, storage, virtual, machine, svm, provision, lun, fc, hba, esx, host, computer, decide whether to use the fc configuration for esx express guide
...
---
= Decide whether to use the FC Configuration for ESX Express Guide
:icons: font
:imagesdir: ../media/
