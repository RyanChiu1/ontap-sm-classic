---
permalink: smb-config/reference_where_to_find_additional_information_nas_protocol.html
sidebar: sidebar
keywords: 
summary: 'After you have successfully tested CIFS client access, you can perform advanced CIFS configuration or add SAN access. When protocol access is complete, you should protect the root volume of SVM. There are express guides, comprehensive guides, and technical reports to help you achieve these goals.'
---
